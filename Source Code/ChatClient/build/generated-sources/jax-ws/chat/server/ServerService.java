 ...
 * 
 */
@WebServiceClient(name = "ServerService", targetNamespace = "http://server.chat/", wsdlLocation = "http://localhost:28082/ChatServer/ServerService?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:28082/ChatServer/ServerService?wsdl");
