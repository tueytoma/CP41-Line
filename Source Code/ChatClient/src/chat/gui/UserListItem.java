...
public class UserListItem extends JPanel {
     ...
     */
    public UserListItem(Dimension arcs, String username, JFrame parent) {
        super();
    ...
    private void init() {
        ...
        addMouseListener(new MouseAdapter() {
            ...
            public void mousePressed(MouseEvent e) {
                ...
                @Override
                public void run() {
                    parent.messagePanel.chatPanel.scroller.getVerticalScrollBar().setValue(parent.messagePanel.chatPanel.scroller.getVerticalScrollBar().getMaximum());
                    revalidate();
                    repaint();
                    }           
                },50);
