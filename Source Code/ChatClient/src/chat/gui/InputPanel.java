...
public class InputPanel extends JPanel {
    ...
    private final Color BACKGROUND_ON_FOCUS = new Color(243,243,243);
    private final Color SELECTION_COLOR = new Color(125, 192, 254);
    private final Color BUTTON_COLOR = new Color(85,139,217);
    private final Color BUTTON_COLOR_ON_HOVER = new Color(57,102,217);
    private final Dimension SIZE = new Dimension(0, 80);
    private final Dimension INPUT_FIELD_SIZE = new Dimension(200, 35);
    private final Font DEFAULT_FONT = new Font(Font.SANS_SERIF, Font.BOLD, 14);
    private final Font SEND_IMAGE_FONT = new Font(Font.SANS_SERIF, Font.BOLD, 50);
